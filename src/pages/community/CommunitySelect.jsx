  ...
  return (
    <>
      <S.Search>
        ...
        <S.Filter>
          <S.FilterNew
          $active = {activeFilter === "최신순"} onClick={() => handleFilterClick("최신순")}>
            최신순</S.FilterNew>
          <S.FilterHot
          $active = {activeFilter === "인기순"} onClick={() => handleFilterClick("인기순")}>
            인기순</S.FilterHot>
          <S.FilterMy
          $active = {activeFilter === "내가 쓴 게시글"} onClick={() => handleFilterClick("내가 쓴 게시글")}>
            내가 쓴 게시글</S.FilterMy>
          <S.FilterFriend
          $active = {activeFilter === "내 친구가 쓴 게시글"} onClick={() => handleFilterClick("내 친구가 쓴 게시글")}>
