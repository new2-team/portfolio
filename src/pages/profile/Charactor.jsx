...
const Charactor = forwardRef((_, ref) => {
    ...
    const selectCharactor = (id) => {
        ...
        useImperativeHandle(ref, () => ({
            getValue: () => ({
                value: selectedCharactor,
                isValid: selectedCharactor !== undefined && selectedCharactor !== null,
            }),
    ...
    return (
        <Container style={{padding:0}}>
            <S.InputWrapper>
                <S.inputinline>
                    <S.NamekgWrap style={{marginRight:'30px'}} onClick={()=>selectCharactor(1)} selectedCharactor={selectedCharactor === 1}>
